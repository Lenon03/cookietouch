...
export default class ExchangeFrame {
  ...
  private async HandleExchangeStartedWithPodsMessage(account: Account, message: any) {
    account.game.exchange.UpdateExchangeStartedWithPodsMessage(message);
  }

  private async HandleExchangeObjectAddedMessage(account: Account, message: any) {
    account.game.exchange.UpdateExchangeObjectAddedMessage(message);
  }

  private async HandleExchangeObjectModifiedMessage(account: Account, message: any) {
    account.game.exchange.UpdateExchangeObjectModifiedMessage(message);
  }

  private async HandleExchangeObjectRemovedMessage(account: Account, message: any) {
    account.game.exchange.UpdateExchangeObjectRemovedMessage(message);
  }

  private async HandleExchangeKamaModifiedMessage(account: Account, message: any) {
